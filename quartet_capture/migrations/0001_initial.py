...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Rule',
            fields=[
                ('name', models.CharField(help_text='A rule is composed of multiple steps that execute in order.', max_length=100, primary_key=True, serialize=False, verbose_name='Rule')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='A short description.', max_length=500, null=True, verbose_name='Description')),
                ('step_class', models.CharField(help_text='The full python path to where the Step class is definedfor example, mypackage.mymodule.MyStep', max_length=100, verbose_name='Class Path')),
                ('order', models.IntegerField(help_text='Defines the order in which the step is executed.  Stepsare executed in numerical order.', unique=True, verbose_name='Execution Order')),
